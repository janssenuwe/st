...
/**
 * @author U. Janssen
 * @description Do not store any credentials in this file
 * Rather, take it from configfile which is not be checked in
 * @return database connection
 */
function getDBConn() {
    $configFileLocation = "../../../config/autoload/local.php";

    $configArray = include_once ($configFileLocation);
    $user = $configArray['db']['username'];
    $pwd = $configArray['db']['password'];

    // get Database connection
    $objDB = mysqli_connect('dedi1612.your-server.de',$user,$pwd,'stellu_db1');
