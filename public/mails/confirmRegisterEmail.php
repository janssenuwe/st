...
<span style='font-size: 16pt; font-weight: bold; padding-bottom: 50px;'>Daten vervollständigt</span>
<br /><br /><br />
Grüß Gott, ".(empty($objUserIdenCurrent->user_titel) ? $objUserIdenCurrent->user_anrede : $objUserIdenCurrent->user_anrede." ".$objUserIdenCurrent->user_titel)." ".utf8_encode($objUserIdenCurrent->user_vorname)." ".utf8_encode($objUserIdenCurrent->user_nachname).",
<br /><br /> 
vielen Dank für die Vervollständigung Ihrer Daten.
<br /><br />
Unser Team wird Ihre Daten nun prüfen und Ihren Account freischalten. Nach der Freischaltung können Sie sich mit Ihrer E-Mail-Adresse und dem von Ihnen gewählten Passwort auf <a href='http://www.stellenanzeigen-texten.de/check/public/' target='_blank' style='color: #ff0000;'>www.stellenanzeigen-texten.de</a> in die TOOLBOX für Stellenanzeigen einloggen.
<br /> <br /> 
