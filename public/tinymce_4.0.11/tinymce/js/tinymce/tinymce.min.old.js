...
!function(e, t) {
    ...
    r(l, [], function() {
        ...
        return e.extend({layout: "", innerClass: "container-inner", init: function(e) {
                ...
                return e.preRender(), t.preRender(e), '<div id="' + e._id + '" class="' + e.classes() + '" S' + this.settings.role + '"><div id="' + e._id + '-body" class="' + e.classes("body") + '">' + (e.settings.html || "") + t.renderHtml(e) + "</div></div>"
            }, postRender: function() {
                var e = this, t;
        ...
        return function(a) {
            ...
            function u() {
                function t(e) {
                    ...
                    if (n.collapsed || (e = !0), l = n[(e ? "start" : "end") + "Container"], c = n[(e ? "start" : "end") + "Offset"], 3 == l.nodeType && (r = W.getParent(n.startContainer, W.isBlock), e && (r = W.getNext(r, W.isBlock)), !r || !t() && n.collapsed || (i = W.create("em", {id: "__mceDel"}), I(o.grep(r.childNodes), function(e) {
                        ...
                        for (s = V.getBookmark(); u = W.get("__mceDel"); )
                            W.remove(u, !0);
                        V.moveToBookmark(s)
                    }
                }
            ...
            function d() {
                ...
                a.on("keydown", function(e) {
                    var t = e.keyCode, r, i;
                    if (!c(e) && (t == z || t == F)) {
                        if (r = a.selection.isCollapsed(), i = a.getBody(), r && !W.isEmpty(i))
                            return;
        ...
        return e.extend({recalc: function(e) {
                ...
                if (x = {}, x[E] = 0 > d ? i[E] - d + i[B] : i[R] - d + i[B], x[P] = _ + i[z], x[L] = i[R] - d, x[W] = _, x.minW = U(x.minW, i.maxW), x.minH = U(x.minH, i.maxH), x.minW = V(x.minW, i.startMinWidth), x.minH = V(x.minH, i.startMinHeight), !i.autoResize || x.minW == i.minW && x.minH == i.minH) {
                    ...
                    for (C = d / u, w = o[T], x = {}, 0 === u && ("end" == l?w = d + o[T]:"center" == l?(w = Math.round(i[R] / 2 - (i[R] - d) / 2) + o[T], 0 > w && (w = o[T])):"justify" == l && (w = o[T], c = Math.floor(d / (r.length - 1)))), x[H] = o[I], t = 0, n = r.length; n > t; t++)
                        p = r[t], h = p.layoutRect(), y = h.maxFlexSize || h[E], "center" === s ? x[H] = Math.round(i[D] / 2 - h[M] / 2) : "stretch" === s ? (x[M] = V(h[P] || 0, i[D] - o[I] - o[F]), x[H] = o[I]) : "end" === s && (x[H] = i[D] - h[M] - o.top), h.flex > 0 && (y += h.flex * C), x[N] = y, x[k] = w, p.layoutRect(x), p.recalc && p.recalc(), w += y + c
        ...
        function a(e) {
            ...
            function o() {
                ...
                var r = 0, i = [], o = [{title: "Standard", format: "p"}, {title: "Header 1", format: "h1"}, {title: "Header 2", format: "h2"}, {title: "Header 3", format: "h3"}, {title: "Header 4", format: "h4"}, {title: "Header 5", format: "h5"}, {title: "Header 6", format: "h6"}];
                e.on("init", function() {
                    s(i, function(t) {
